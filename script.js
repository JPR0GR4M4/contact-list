...
// Función para actualizar un contácto de la lista //*
...
function actualizarContacto(
  ...
  const contactoActualizado = listaContactos.findIndex(
    (contactoActualizado) => contactoActualizado.id === id
  );

  if (contactoActualizado >= 0) {
    listaContactos[contactoActualizado].nombres = nombres;
    listaContactos[contactoActualizado].apellidos = apellidos;
    listaContactos[contactoActualizado].telefono = telefono;
    listaContactos[contactoActualizado].correo = correo;
    listaContactos[contactoActualizado].ubicacion = ubicacion;
    listaContactos[contactoActualizado].ciudad = ciudad;
    listaContactos[contactoActualizado].direccion = direccion;
  }
}
